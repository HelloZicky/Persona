...
# TYPE_LIST = ["base", "base_finetune", "meta", "meta_ood2"]
# TYPE_LIST = ["meta_random", "meta_ood_ocsvm", "meta_ood_lof", "meta_ood2"]
...
# TYPE_LIST1 = ["base", "base_finetune", "meta", "meta_ood2"]
# TYPE_LIST1 = ["base", "base_finetune", "meta", "meta_gru", "meta_random", "meta_ood", "meta_ood_gru", "meta_ood_uncertainty"]
TYPE_LIST1 = ["base", "base_finetune", "meta", "meta_gru", "meta_random", "meta_ood_ocsvm", "meta_ood_lof", "meta_ood", "meta_ood_gru", "meta_ood_uncertainty"]
...
with open(result_file, "w+") as writer, open(result_csv1, "w+") as csv_writer1:
        ...
        for model in MODEL_LIST:
            for type in TYPE_LIST:
                if type in TYPE_LIST1:
                    writer_temp = writer
                    csv_writer_temp = csv_writer1
                # elif type in TYPE_LIST2:
                #     writer_temp = writer2
                else:
                    continue
                ...
                with open(log_file, "r+") as reader:
                    ...
                    for key, value in result_dict.items():
                        ...
                        # if type == "base":
                        # if type == TYPE_LIST1[0] or type == TYPE_LIST2[0]:
                        #     # print("-" * 50, file=writer)
                        #     print("-" * 50, file=writer_temp)

                        # if type == "meta_ood" or type == "meta_ood_gru" or type == "meta_random":
                        if "ood" in type.split("_") or "ood2" in type.split("_") or type == "meta_random":
                            for _writer in [writer_temp, csv_writer_temp]:
                                print("{},{},{},{},{},{},{},{},{}".format("{:10s}".format(model), "{:24s}".format(type),
                                      ...
                                      # "{:6s}".format(",".join(result_dict2["{} {}".format(model, type)])),
                                      ...
                                      # "{:6s}".format(",".join(result_dict7["{} {}".format(model, type)])),
                                      # "{:6s}".format(",".join(result_dict8["{} {}".format(model, type)])),
