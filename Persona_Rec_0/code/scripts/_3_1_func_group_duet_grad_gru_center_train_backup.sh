...
CHECKPOINT_PATH=../checkpoint/NIPS2023/${dataset}_${model}/meta_grad_gru_center_group_${group_num}_backup
...
python ../main_new/multi_metric_meta_grad_group_center_train2_backup.py \
--dataset=${data} \
