...
TYPE_LIST = ["meta_ood_ocsvm", "meta_ood_lof", "meta_random", "meta_ood", "meta_ood_uncertainty5", "meta_ood_uncertainty5_2", "meta_ood_uncertainty5_onlyu"]
...
# TYPE_LIST_reverse = ["meta_random", "meta_ood", "meta_ood_ocsvm", "meta_ood_lof", "meta_ood_uncertainty5", "meta_ood_uncertainty5_2", "meta_ood_uncertainty5_onlyu"]
...
for dataset in DATASET_LIST:
    ...
    for model in MODEL_LIST:
        ...
        for type in TYPE_LIST + ["meta"]:
            ...
            if type in ["meta_random", "meta_ood", "meta_ood_uncertainty", "meta_ood_uncertainty5", "meta_ood_uncertainty5_2", "meta_ood_uncertainty5_onlyu", "meta_ood_uncertainty6", "meta_ood_ocsvm", "meta_ood_lof"]:
            ...
            if type in ["meta_random", "meta_ood", "meta_ood_uncertainty", "meta_ood_uncertainty5", "meta_ood_uncertainty5_2", "meta_ood_uncertainty5_onlyu", "meta_ood_uncertainty6", "meta_ood_lof", "meta_ood_ocsvm"]:
        ...
        #                                      ndcg20_dict, hr5_dict, hr10_dict, hr20_dict]):
            ...
            rate_list = []
            # TYPE_LIST = ["meta_ood_ocsvm", "meta_ood_lof", "meta_random", "meta_ood", "meta_ood_uncertainty5", "meta_ood_uncertainty5_2", "meta_ood_uncertainty5_onlyu"]
            for type, color, legend_name, shape in zip(TYPE_LIST + ["meta"], ["green", "orange", "red", "blue", "black", "pink", "silver", "skyblue"],
                                                   # ["DUET (OC-SVM)", "DUET (LOF)", "DUET (Random)", "MR-DUET (w/o DM)", "MR-DUET (DM5)", "DUET"],
                                                   ["DUET (OC-SVM)", "DUET (LOF)", "DUET (Random)", "MR-DUET (w/o DM)", "MR-DUET", "MR-DUET2", "MR-DUET (w/o MSD)", "DUET"],
                                                   ["*", "o", "s", "x", ".", "_", "_", "_"]):
                # TYPE_LIST = ["meta_random", "meta_ood", "meta_ood_ocsvm", "meta_ood_lof"]
                ...
                # if type in ["meta_random", "meta_ood", "meta_ood_uncertainty", "meta_ood_uncertainty5", "meta_ood_uncertainty6"]:
                    ...
                    if interpolation:
                        ...
                        rate_dict_temp, metric_dict_temp = smooth_xy(rate_dict[type], metric_dict[type])

                    else:
                        # rate_dict_temp, metric_dict_temp = rate_dict[type][min_index:max_index], metric_dict[type][min_index:max_index]
                        rate_dict_temp, metric_dict_temp = rate_dict[type], metric_dict[type]
