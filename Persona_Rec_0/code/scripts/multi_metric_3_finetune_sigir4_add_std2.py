...
result_csv1 = os.path.join(ROOT_FOLDER, "result_ood2.csv")
...
with open(result_file, "w+") as writer2, open(result_csv2, "w+") as csv_writer2:
    for dataset in DATASET_LIST:
        ...
        for model in MODEL_LIST:
            for type in TYPE_LIST:
                if type in TYPE_LIST2:
                    writer_temp = writer2
                    csv_writer_temp = csv_writer2
