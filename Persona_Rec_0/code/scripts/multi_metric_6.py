...
TYPE_LIST = ["base", "meta", "meta_grad", "meta_grad_group_5", "meta_grad_group_10", "meta_grad_group_50"]
    ...
    for dataset in DATASET_LIST:
        ...
        for model in MODEL_LIST:
            for type in TYPE_LIST:
                ...
                #     # log_file = os.path.join(ROOT_FOLDER, "{}_{}".format(dataset, model), type, "log_overall.txt")
                #     log_file = [file for file in os.listdir(os.path.join(ROOT_FOLDER, "{}_{}".format(dataset, model), type)) if file.split(".")[-1] == "txt"]
