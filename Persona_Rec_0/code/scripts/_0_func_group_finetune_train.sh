...
#CHECKPOINT_PATH_FINETUNE=../checkpoint/NIPS2023/${dataset}_${model}/base_group_finetune
######################################################################
...
T_PATH} --arch_config=${ARCH_CONF_FILE} --group_num=${group_num} --train_mode=${train_mode}"
...
#python ../main_new/multi_metric_vanilla_train2.py \
python ../main_new/multi_metric_vanilla_train2_group_finetune.py \
--dataset=${dataset} \
