...
#SNAPSHOT=10000
SNAPSHOT=80000
ARCH_CONF_FILE=`pwd`/movielens_10m_conf.json
...
######################################################################
LEARNING_RATE=0.001
CHECKPOINT_PATH=lzq/SIGIR2023/checkpoint/movielens_10m_din_meta_new/
######################################################################
...
USER_DEFINED_ARGS="--model=meta_din --num_loading_workers=16 --arch_config=${ARCH_CONFIG_CONTENT} --learning_rate=${LEARNING_RATE} \
...
-Dtables=\"odps://graph_embedding_intern_dev/tables/tds_movielens_10m_train_dataset_seq30\,odps://graph_embedding_intern_dev/tables/tds_movielens_10m_test_dataset_seq30\" \
