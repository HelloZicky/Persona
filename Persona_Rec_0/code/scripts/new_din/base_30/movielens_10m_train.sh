...
######################################################################
LEARNING_RATE=0.001
CHECKPOINT_PATH=lzq/SIGIR2023/checkpoint/movielens_10m_din_base_new/
######################################################################
...
-Dtables=\"odps://graph_embedding_intern_dev/tables/tds_movielens_10m_train_dataset_seq30_base\,odps://graph_embedding_intern_dev/tables/tds_movielens_10m_test_dataset_seq30_base\" \
