...
######################################################################
LEARNING_RATE=0.001
CHECKPOINT_PATH=../../../checkpoint/SIGIR2023/douban_book_din/meta_ood_ocsvm
MODEL_PATH=../../../checkpoint/SIGIR2023/douban_book_din/meta
######################################################################
...
USER_DEFINED_ARGS="--model=meta_din_ood_ocsvm --num_loading_workers=1 --arch_config=${ARCH_CONFIG_CONTENT} --learning_rate=${LEARNING_RATE} \
