...
cd ../../..
rm model_alipay.tar.gz
tar -czf model_alipay.tar.gz ./main ./loader ./model ./util ./module
cd scripts/DIN/meta

######################################################################
MODEL_NAME=alipay_din_meta
#STEP=4100
STEP=8200
#STEP=12300
#STEP=16400
...
-Doutputs=\"odps://graph_embedding_intern_dev/tables/tds_alipay_rerank_model_infer_result_seq30_meta/version=torch_${OUTPUT_VERSION}\"
