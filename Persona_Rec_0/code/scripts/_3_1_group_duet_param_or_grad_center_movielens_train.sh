...
#sleep 24600
#sleep 3600
#dataset_list=("movielens_1m" "amazon_electronic")
#dataset_list=("movielens_100k")
#dataset_list=("movielens_1m" "movielens_100k" "douban_book" "douban_music")
...
#dataset_list=("douban_music" "movielens_1m")
#dataset_list=("movielens_1m")
...
#          for type in _3_1_func_group_duet_grad_gru_train
          for type in _3_1_func_group_duet_grad_gru_center_movielens_train
...
wait # 等待所有任务结束
date
# bash _3_1_func_group_duet_grad_gru_center_movielens_train.sh movielens_1m sasrec 2 0 1.0 meta_grad
# bash _3_1_func_group_duet_grad_gru_center_movielens_train.sh movielens_1m sasrec 2 3 0.5
# bash _3_1_func_group_duet_grad_gru_center_movielens_train.sh movielens_1m gru4rec 2 3 0.5
#sleep 1800
#for ((i=0; i<${length}; i++));
##for i in {0..${length}-1};
#do
