...
# DATASET_LIST = ["douban_book", "douban_music", "amazon_cds", "amazon_electronic"]
# DATASET_LIST = ["douban_music", "douban_book"]
...
TYPE_LIST__ = ["meta_random", "meta_ood_uncertainty5", "meta_ood_ocsvm", "meta_ood_lof", ]
...
for dataset in DATASET_LIST:
    ...
    for model in MODEL_LIST:
        ...
        #                                      ndcg20_dict, hr5_dict, hr10_dict, hr20_dict]):
            ...
            rate_list = []
            temp_dict = {}
            # for type, color, legend_name, shape in zip(TYPE_LIST + ["meta"], ["green", "orange", "red", "black", "skyblue"],
            #                                        # ["DUET (OC-SVM)", "DUET (LOF)", "DUET (Random)", "MR-DUET (w/o DM)", "MR-DUET (DM5)", "DUET"],
            #                                        ["DUET (OC-SVM)", "DUET (LOF)", "DUET (Random)", "MR-DUET", "DUET"],
            #                                        ["*", "o", "s", "x", ".", "_", "_", "_"]):
            for type, color, legend_name, shape in zip(TYPE_LIST__ + ["meta"], ["red", "black", "green", "orange", "skyblue"],
                                                   # ["DUET (OC-SVM)", "DUET (LOF)", "DUET (Random)", "MR-DUET (w/o DM)", "MR-DUET (DM5)", "DUET"],
                ...
                # if type in ["meta_random", "meta_ood", "meta_ood_uncertainty", "meta_ood_uncertainty5", "meta_ood_uncertainty6"]:
                    ...
                    if type not in ["meta_ood_ocsvm", "meta_ood_lof"]:
                    # if type in ["meta"]:
                        # print()
            ...
            plt.savefig(os.path.join(ROOT_FOLDER, "{}_{}".format(dataset, model), '{}_main.png'.format(metric_name)), format='png', bbox_inches='tight')
            plt.savefig(os.path.join(ROOT_FOLDER, "{}_{}".format(dataset, model), '{}_main.pdf'.format(metric_name)), format='pdf', bbox_inches='tight')
            # plt.sca(ax)
            # plt.close()
            plt.clf()
            plt.cla()
