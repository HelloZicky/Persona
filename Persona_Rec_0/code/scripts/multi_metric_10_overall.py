...
# TYPE_LIST = ["base", "base_finetune", "meta", "meta_grad", "meta_grad_no_clip", "meta_grad2", "meta_grad2_no_clip", "meta_grad_gru", "meta_grad_no_clip_gru"]
# TYPE_LIST = ["base", "base_finetune", "meta", "meta_grad", "meta_grad_gru", "meta_grad_no_clip", "meta_grad_no_clip_gru"]
TYPE_LIST = ["base", "base_finetune", "base_finetune_1_session",  "meta",
...
# TYPE_LIST = ["base", "base_finetune", "meta", "meta_grad", "meta_grad_gru", "meta_grad_no_clip", "meta_grad_no_clip_gru", "meta_grad2", "meta_grad2_no_clip"]
...
# NAME_LIST = ["Base", "Finetune", "DUET", "DUET (Grad.)", "DUET (Grad.)-no_clip", "DUET (Grad.2)", "DUET (Grad.2)-no_clip"]
# NAME_LIST = ["Base", "Finetune", "DUET", "DUET (Grad.)", "DUET (Grad.)-no_clip", "DUET (Grad.2)", "DUET (Grad.2)-no_clip", "DUET (Grad.GRU)", "DUET (Grad.GRU)-no_clip"]
# NAME_LIST = ["Base", "Finetune", "DUET", "DUET (Grad.)", "DUET (Grad.GRU)", "DUET (Grad.)-no_clip", "DUET (Grad.GRU)-no_clip"]
NAME_LIST = ["Base", "Finetune", "Finetune (ub)", "DUET",
...
# NAME_LIST = ["Base", "Finetune", "DUET", "DUET (Grad.)", "DUET (Grad.GRU)", "DUET (Grad.)-no_clip", "DUET (Grad.GRU)-no_clip", "DUET (Grad.2)", "DUET (Grad.2)-no_clip"]
# TYPE_LIST = ["base"]
...
result_file = os.path.join(ROOT_FOLDER, "result_ood_overall_rebuttal.txt")
result_file2 = os.path.join(ROOT_FOLDER, "result2_ood_overall_rebuttal.txt")
# csv_writer1 = csv.writer(open(os.path.join(ROOT_FOLDER, "result_ood.csv"), 'w+', encoding='utf-8', newline=''))
result_csv1 = os.path.join(ROOT_FOLDER, "result_ood1_overall_rebuttal.csv")
result_csv2 = os.path.join(ROOT_FOLDER, "result_ood2_overall_rebuttal.csv")
    ...
    for dataset in DATASET_LIST:
        ...
        for model in MODEL_LIST:
            for (type, name) in zip(TYPE_LIST, NAME_LIST):
                ...
                # if type in ["base", "meta", "meta_grad", "meta_grad_no_clip", "meta_grad2", "meta_grad2_no_clip"]:
                # if type in ["base", "meta", "meta_grad", "meta_grad_no_clip", "meta_grad2", "meta_grad2_no_clip", "meta_grad_gru", "meta_grad_no_clip_gru"]:
                ...
                elif type == "base_finetune" or "base_finetune_1_session":
                ...
                for log_file in log_files:
                    ...
                    with open(log_file, "r+") as reader:
                        for index, line in enumerate(reader, 1):
                            # if model == "din" and dataset == "movielens_100k" and type == "meta_grad_gru":
                            #     print("***", index)
                            # print(line.strip("\n"))
                            ...
                            # if model == "din" and dataset == "movielens_100k" and type == "meta_grad_gru":
                            #     print("+" * 20)
                            #     print("read auc ", [auc, auc_user, ndcg5, hr5, ndcg10, hr10, ndcg20, hr20, rate])
                            ...
                            if type in ["base", "base_finetune", "base_finetune_1_session"]:
                                rate = 0.0
                            ...
                            # elif type in ["meta", "meta_grad", "meta_grad_no_clip", "meta_grad2", "meta_grad2_no_clip"]:
                            elif type in ["meta",
                            "meta_grad", "meta_grad_gru",
                            "meta_grad_gru_center_group_2_clip_0.5", "meta_grad_gru_center_group_3_clip_0.5",
                            "meta_grad_gru_center_group_5_clip_0.5", "meta_grad_gru_center_group_10_clip_0.5",
                            ...
                            "meta_grad_gru_center_group_5_clip_1.0", "meta_grad_gru_center_group_10_clip_1.0",
                                ...
                                if auc_user > max_auc:
                                    ...
                                    max_auc = auc_user
                                    # if model == "din" and dataset == "movielens_100k" and type == "meta_grad_gru":
                                    #     print("update best auc ", [auc, auc_user, ndcg5, hr5, ndcg10, hr10, ndcg20, hr20, rate])
