...
######################################################################
LEARNING_RATE=0.001
CHECKPOINT_PATH=../../../checkpoint/SIGIR2023/taobao_sasrec/meta_gru
######################################################################
...
USER_DEFINED_ARGS="--model=meta_sasrec_gru --num_loading_workers=1 --arch_config=${ARCH_CONFIG_CONTENT} --learning_rate=${LEARNING_RATE} \
