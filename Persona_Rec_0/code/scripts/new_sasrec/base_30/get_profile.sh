...
######################################################################
LEARNING_RATE=0.001
CHECKPOINT_PATH=lzq/SIGIR2023/checkpoint/movielens_sasrec_base_new_get_profile/
######################################################################
...
USER_DEFINED_ARGS="--model=sasrec --num_loading_workers=16 --arch_config=${ARCH_CONFIG_CONTENT} --learning_rate=${LEARNING_RATE} \
