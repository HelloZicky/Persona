...
######################################################################
LEARNING_RATE=0.001
CHECKPOINT_PATH=../../../checkpoint/SIGIR2023/alipay_sasrec/
######################################################################
...
USER_DEFINED_ARGS="--model=sasrec --num_loasasrecg_workers=1 --arch_config=${ARCH_CONFIG_CONTENT} --learning_rate=${LEARNING_RATE} \
