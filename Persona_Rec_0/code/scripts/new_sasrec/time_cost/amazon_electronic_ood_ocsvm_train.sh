...
######################################################################
LEARNING_RATE=0.001
CHECKPOINT_PATH=../../../checkpoint/SIGIR2023/amazon_electronic_sasrec/meta_ood_ocsvm_time_cost
MODEL_PATH=../../../checkpoint/SIGIR2023/amazon_electronic_sasrec/meta
######################################################################
...
USER_DEFINED_ARGS="--model=meta_sasrec_ood_ocsvm_time_cost --num_loading_workers=1 --arch_config=${ARCH_CONFIG_CONTENT} --learning_rate=${LEARNING_RATE} \
...
python ../../../main_new/multi_metric_meta_ood_baseline_train4_time_cost.py \
--dataset=${data} \
${USER_DEFINED_ARGS}
