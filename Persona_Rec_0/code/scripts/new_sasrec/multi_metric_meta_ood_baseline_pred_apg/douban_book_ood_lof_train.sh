...
######################################################################
LEARNING_RATE=0.001
CHECKPOINT_PATH=../../../checkpoint/SIGIR2023/douban_book_sasrec/meta_ood_lof_apg
...
USER_DEFINED_ARGS="--model=meta_sasrec_ood_lof_apg --num_loading_workers=1 --arch_config=${ARCH_CONFIG_CONTENT} --learning_rate=${LEARNING_RATE} \
