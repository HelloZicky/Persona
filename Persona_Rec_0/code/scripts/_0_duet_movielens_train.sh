...
#          for type in _0_func_group_finetune_movielens_train
          # for type in _0_func_base_movielens_train _0_func_finetune_1_session_movielens_train
          # for type in _0_func_base_movielens_pred
          for type in _0_func_finetune_1_session_movielens_train
          do
            {
