...
TYPE_LIST = ["meta_ood_uncertainty", "meta_ood_uncertainty5_2", "meta_ood_uncertainty5"]
...
result_file = os.path.join(ROOT_FOLDER, "request_curve_loss_func.txt")
fig_file = os.path.join(ROOT_FOLDER, "request_curve_loss_func.png")
...
for dataset in DATASET_LIST:
    ...
    for model in MODEL_LIST:
        ...
        for type in TYPE_LIST + ["meta"]:
            ...
            if type in ["meta_random", "meta_ood", "meta_ood_uncertainty", "meta_ood_uncertainty5_2", "meta_ood_uncertainty5", "meta_ood_uncertainty6", "meta_ood_ocsvm", "meta_ood_lof"]:
            ...
            if type in ["meta_random", "meta_ood", "meta_ood_uncertainty", "meta_ood_uncertainty5_2", "meta_ood_uncertainty5", "meta_ood_uncertainty6", "meta_ood_lof", "meta_ood_ocsvm"]:
        ...
        #                                      ndcg20_dict, hr5_dict, hr10_dict, hr20_dict]):
            ...
            metric_list = []
            rate_list = []
            for type, color, legend_name, shape in zip(TYPE_LIST, ["green", "orange", "red", "blue", "black", "skyblue"],
                                                   # ["DUET (OC-SVM)", "DUET (LOF)", "DUET (Random)", "MR-DUET (w/o DM)", "MR-DUET (DM5)", "DUET"],
                                                   ["meta_ood_uncertainty", "meta_ood_uncertainty5_2", "meta_ood_uncertainty5"],
                                                   ["*", "o", "s", "x", ".", "_", "_", "_"]):
                # TYPE_LIST = ["meta_random", "meta_ood", "meta_ood_ocsvm", "meta_ood_lof"]
                # TYPE_LIST = ["meta_ood_uncertainty", "meta_ood_uncertainty5_2", "meta_ood_uncertainty5"]
            ...
            plt.savefig(os.path.join(ROOT_FOLDER, "{}_{}".format(dataset, model), '{}_loss_func.png'.format(metric_name)), format='png', bbox_inches='tight')
            plt.savefig(os.path.join(ROOT_FOLDER, "{}_{}".format(dataset, model), '{}_loss_func.pdf'.format(metric_name)), format='pdf', bbox_inches='tight')
            # plt.sca(ax)
            # plt.close()
            plt.clf()
            plt.cla()
