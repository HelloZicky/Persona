...
CHECKPOINT_PATH=../checkpoint/NIPS2023/${dataset}_${model}/meta_grad
...
T_PATH} --arch_config=${ARCH_CONF_FILE} --pretrain_model_path=${pretrain_model_path} --pretrain --grad_norm_=${grad_norm_}"
