...
######################################################################
LEARNING_RATE=0.001
CHECKPOINT_PATH=../../../checkpoint/SIGIR2023/douban_book_gru4rec/meta_ood_uncertainty5_apg
######################################################################
...
#dataset="../../../../data/douban_book/generate_dataset"
#dataset="../../../../data/douban_book/ood_generate_dataset"
#dataset="../../../../data/douban_book/ood_generate_dataset_tiny"
dataset="../../../../data/douban_book/ood_generate_dataset_tiny_10_30u30i"
#dataset="../../../../data/douban_book/ood_generate_dataset_large"
train_file="${dataset}/train.txt"
test_file="${dataset}/test.txt"
data="${train_file},${test_file}"

positive_dataset="../../../../data/douban_book/ood_generate_dataset_tiny_10_30u30i_positive"
