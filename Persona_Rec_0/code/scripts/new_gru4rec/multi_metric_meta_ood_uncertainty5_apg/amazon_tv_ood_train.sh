...
######################################################################
LEARNING_RATE=0.001
CHECKPOINT_PATH=../../../checkpoint/SIGIR2023/amazon_tv_gru4rec/meta_ood_uncertainty5_apg
######################################################################
...
positive_dataset="../../../../data/Amazon_tv/ood_generate_dataset_tiny_10_30u30i_positive"
