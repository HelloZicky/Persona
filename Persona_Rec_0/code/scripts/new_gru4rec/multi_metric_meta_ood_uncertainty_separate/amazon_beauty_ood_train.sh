...
######################################################################
LEARNING_RATE=0.001
CHECKPOINT_PATH=../../../checkpoint/SIGIR2023/amazon_beauty_gru4rec/meta_ood_uncertainty_separate
######################################################################
...
USER_DEFINED_ARGS="--model_uncertainty=meta_gru4rec_ood_uncertainty_separate --model=meta_gru4rec --num_loading_workers=1 --arch_config=${ARCH_CONFIG_CONTENT} --learning_rate=${LEARNING_RATE} \
...
#dataset="../../../../data/Amazon_beauty/ood_generate_dataset"
...
positive_dataset="../../../../data/Amazon_beauty/ood_generate_dataset_tiny_10_30u30i_positive"
