...
######################################################################
LEARNING_RATE=0.001
CHECKPOINT_PATH=../../../checkpoint/SIGIR2023/douban_book_gru4rec/meta_ood_ocsvm_apg
MODEL_PATH=../../../checkpoint/SIGIR2023/douban_book_gru4rec/meta_apg
######################################################################
...
USER_DEFINED_ARGS="--model=meta_gru4rec_ood_ocsvm_apg --num_loading_workers=1 --arch_config=${ARCH_CONFIG_CONTENT} --learning_rate=${LEARNING_RATE} \
