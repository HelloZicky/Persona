...
######################################################################
LEARNING_RATE=0.001
CHECKPOINT_PATH=../../../checkpoint/SIGIR2023/alipay_gru4rec/meta_hyper_attention
######################################################################
...
USER_DEFINED_ARGS="--model=meta_gru4rec_hyper_attention --num_loagru4recg_workers=1 --arch_config=${ARCH_CONFIG_CONTENT} --learning_rate=${LEARNING_RATE} \
