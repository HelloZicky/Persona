...
result_csv1 = os.path.join(ROOT_FOLDER, "result_ood1.csv")
result_csv2 = os.path.join(ROOT_FOLDER, "result_ood2.csv")
                ...
                for log_file in log_files:
                    ...
                    with open(log_file, "r+") as reader:
                        for index, line in enumerate(reader, 1):
                            ...
                            elif type in ["meta", "meta_grad", "meta_grad_no_clip", "meta_grad2", "meta_grad2_no_clip", "meta_grad_gru", "meta_grad_no_clip_gru"]:
                                rate = 100.0
                            else:
