...
#          for type in _2_func_duet_grad_movielens_pred
#          for type in _2_func_duet_grad_gru_movielens_pred
          for type in _2_func_duet_grad_movielens_pred _2_func_duet_grad_gru_movielens_pred
          do
            {
...
wait # 等待所有任务结束
date
# bash _1_func_duet_grad_pred.sh amazon_beauty din 3
# bash _1_func_duet_grad_pred.sh amazon_beauty din 5 0
