...
result_file = os.path.join(ROOT_FOLDER, "result_ood_loss_func.txt")
result_file2 = os.path.join(ROOT_FOLDER, "result2_ood_loss_func.txt")
# csv_writer1 = csv.writer(open(os.path.join(ROOT_FOLDER, "result_ood.csv"), 'w+', encoding='utf-8', newline=''))
result_csv1 = os.path.join(ROOT_FOLDER, "result_ood1_loss_func.csv")
result_csv2 = os.path.join(ROOT_FOLDER, "result_ood2_loss_func.csv")
