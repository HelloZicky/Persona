...
result_file = os.path.join(ROOT_FOLDER, "result_ood_douban.txt")
result_file2 = os.path.join(ROOT_FOLDER, "result2_ood_douban.txt")
# csv_writer1 = csv.writer(open(os.path.join(ROOT_FOLDER, "result_ood_douban.csv"), 'w+', encoding='utf-8', newline=''))
result_csv1 = os.path.join(ROOT_FOLDER, "result_ood1_douban.csv")
result_csv2 = os.path.join(ROOT_FOLDER, "result_ood2_douban.csv")
# csv_writer2 = csv.writer(open(os.path.join(ROOT_FOLDER, "result_ood2_douban.csv"), 'w+', encoding='utf-8', newline=''))
