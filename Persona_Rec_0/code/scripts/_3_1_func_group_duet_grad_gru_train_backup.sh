...
CHECKPOINT_PATH=../checkpoint/NIPS2023/${dataset}_${model}/meta_grad_gru_group_${group_num}_backup
...
python ../main_new/multi_metric_meta_grad_group_train2_backup2.py \
--dataset=${data} \
${USER_DEFINED_ARGS}
