...
#      for type in multi_metric_meta_ood_uncertainty_pred5_apg multi_metric_meta_random_request_pred_apg
      for type in multi_metric_meta_ood_uncertainty_pred5_apg
...
#            echo douban_${dataset}_train.sh
