...
# scripts_folder = "scripts_0128"
scripts_folder = "scripts"
cuda_std_str = "export CUDA_VISIBLE_DEVICES="
# std_str = "export CUDA_VISIBLE_DEVICES="
std_str = "echo ${USER_DEFINED_ARGS}"
# std_str = "python"
    ...
    for file in files:
        ...
        with open(file_path, "r+") as reader:
            for index, line in enumerate(reader):
                ...
                #     else:
                #         cuda_num = 3
                #     new_str = cuda_std_str + str(int(cuda_num) % 4)
                #     print("---Modified--------", file_path)
                #     records.append(new_str)
                    # print(old_str)
                    # print(new_str)
                    # print(line.strip())
                ...
                # if re.match(std_str, line.strip()):
                if index == 0:
                    # cuda_num = line.strip().split("=")[-1]
                    # old_str = cuda_std_str + cuda_num
                    # if cuda_num == 0 or cuda_num == 2:
