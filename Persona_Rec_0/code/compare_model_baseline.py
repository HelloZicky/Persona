...
for dataset in DATASET_LIST:
    ...
    for model in MODEL_LIST:
        ...
        model_ood_file = os.path.join(ROOT_FOLDER, "{}_{}".format(dataset, model), "meta_ood_lof", "best_auc.pkl")
        ...
        model_uncertainty_file = os.path.join(ROOT_FOLDER, "{}_{}".format(dataset, model), "meta_ood_ocsvm", "best_auc.pkl")
