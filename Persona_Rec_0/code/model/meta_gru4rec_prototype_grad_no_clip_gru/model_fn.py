...
@model("meta_gru4rec_prototype_grad_no_clip_gru", MetaType.ModelBuilder)
class GRU4Rec(nn.Module):
    def __init__(self, model_conf):
        ...
        # self._meta_classifier_param_list = common.HyperNetwork_FC_grad_no_clip(
        self._meta_classifier_param_list = common.HyperNetwork_FC_grad_no_clip_gru(
            # model_conf.id_dimension * 2,
            model_conf.id_dimension,
            # model_conf.classifier + [1],
            [model_conf.id_dimension] * model_conf.mlp_layers,
