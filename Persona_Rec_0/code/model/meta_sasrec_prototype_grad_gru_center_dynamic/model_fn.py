...
@model("meta_sasrec_prototype_grad_gru_center_dynamic", MetaType.ModelBuilder)
class SasRec(nn.Module):
    ...
    def forward(self, features, center_z=None, fig1=False, pretrain_model=None, return_grad=False, grad_norm_=0.5,
        ...
        #                                                       )
        #     if fig1:
        #         user_embedding1, grad_list, mini_grad_list = self._meta_classifier_param_list(user_state, trigger_embed,
        #                                                            user_state.size()[0],
        #                                                            trigger_seq_length,
        #                                                            pretrain_model=pretrain_model,
        #                                                            return_grad=return_grad,
