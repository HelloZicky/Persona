...
@model("meta_gru4rec_prototype_grad_gru_center", MetaType.ModelBuilder)
class GRU4Rec(nn.Module):
    ...
    def forward(self, features, center_z, fig1=False, pretrain_model=None, return_grad=False, grad_norm_=0.5, dynamic_partition=False):
        # Encode target item
        ...
        if return_grad:
            user_embedding, grad_list = self._meta_classifier_param_list(user_state, hist_embed,
                                                              ...
                                                              return_grad=return_grad,
                                                                         center_z=center_z, grad_norm_=grad_norm_, dynamic_partition=dynamic_partition
                                                              )
            if fig1:
