        ...
        if not pred:
            if use_uncertainty_net:
                ...
                if use_mis_recommendation:
                    ...
                    ood_pred = self.mis_recommendation_act1(self.mis_recommendation_layer1(torch.cat([trigger_embed_, user_state], dim=1)))
                    ood_pred = self.mis_recommendation_layer2(torch.cat([ood_pred, output], dim=1))
                return cvae_loss
