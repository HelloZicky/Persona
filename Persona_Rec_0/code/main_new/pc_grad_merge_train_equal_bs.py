...
def train(train_dataloader_list, predict_dataloader_list, model_obj, device, args):
    ...
    best_auc = 0
    max_step = 0
    best_auc_ckpt_path = os.path.join(args.checkpoint_dir, "best_auc_{}".format(args.group_num) + ".pkl")
    print("=" * 50)
...
def main_worker(_):
    ...
    args.checkpoint_dir = os.path.join(args.checkpoint_dir, "2_prototype_long_tail")
